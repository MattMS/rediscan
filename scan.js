...
(function() {
  var R, T, always, append, apply, applySpec, bunyan, curry, curryN, equals, flatten, flip, get_body, get_command_from_request, get_count_from_url_query, get_cursor_from_url_query, get_pattern_from_url_query, get_url_from_request, ifElse, join, juxt, log, make_page, nth, pipe, prepend, prop, redis_scan_from_request, scan_html_maker, send_error, send_ok, tap, url;
  ...
  always = R.always, append = R.append, apply = R.apply, applySpec = R.applySpec, curry = R.curry, curryN = R.curryN, equals = R.equals, flatten = R.flatten, flip = R.flip, ifElse = R.ifElse, join = R.join, juxt = R.juxt, nth = R.nth, pipe = R.pipe, prepend = R.prepend, prop = R.prop, T = R.T, tap = R.tap;
  ...
  scan_html_maker = function(h) {
    return pipe(get_body(h), make_page(h));
  };
